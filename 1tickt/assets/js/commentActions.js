...
function toggleReply(button) {
    var parent = $(button).closest(".itemContainer"); // Closest will get first instance of specified element 
    var commentForm = parent.find(".commentForm").first(); // Find will get first of the child element
...
function updateLikesValue(element, num) {
    var likesCountVal = element.text() || 0; // default to 0 if element is not found 
    element.text(parseInt(likesCountVal) + parseInt(num)); // Convert string to int to update value  
}
